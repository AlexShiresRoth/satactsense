		...
		<section className={videoStyle.section}>
			...
			<div className={videoStyle.text_container}>
				...
				<div className={videoStyle.col}>
					...
					<p>Finally, we create a comprehensive tutoring plan structured around your child’s availability and skillset. Our comprehensive test-prep methods ensure your child has the best testing strategies and is completely prepared on test day.</p>
				</div>
			</div>
		</section>
	);
